...
export function getEnvBaseUrl() {
  ...
  const VITE_SERVER_BASEURL__WEIXIN_DEVELOP = import.meta.env.VITE_SERVER_BASEURL_WEIXIN_DEVELOP
  const VITE_SERVER_BASEURL__WEIXIN_TRIAL = import.meta.env.VITE_SERVER_BASEURL_WEIXIN_TRIAL
  const VITE_SERVER_BASEURL__WEIXIN_RELEASE = import.meta.env.VITE_SERVER_BASEURL_WEIXIN_RELEASE
